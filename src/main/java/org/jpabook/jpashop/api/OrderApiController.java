...
import org.jpabook.jpashop.repository.query.order.OrderFlatDTO;
import org.jpabook.jpashop.repository.query.order.OrderQueryDto;
import org.jpabook.jpashop.repository.query.order.OrderQueryItemDto;
import org.jpabook.jpashop.repository.query.order.OrderQueryRepository;
    ...
    public List<OrderQueryDto> orderV6() {
        ...
        List<OrderQueryDto> collect = flats.stream()
                .collect(groupingBy(o -> new OrderQueryDto(o.getOrderId(), o.getName(), o.getOrderDate(), o.getOrderStatus(), o.getAddress()),
                        mapping(o -> new OrderQueryItemDto(o.getOrderId(), o.getItemName(), o.getOrderPrice(), o.getCount()), toList())
                )).entrySet().stream()
